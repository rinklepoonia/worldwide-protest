...
function EcoSection() {
    return (
        <div className='eco_bg_img pt_200_110 position-relative'>
                ...
                <div className="row justify-content-between">
                    ...
                    <div className="col-lg-6 d-flex justify-content-center pt-lg-0 pt-3">
                        <div className='blank'>
                            ...
                            <h3 className='ff_inter fw-extrabold text64_3xl lh_lg_77 lh_sm_60 lh_43 mt-lg-0 mt-3 mb_lg_20 mb_0'>ECOSYSTEM</h3>
